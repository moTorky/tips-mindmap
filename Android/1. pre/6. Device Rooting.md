...
------------
### root detection
- identify binaries: `su`, `/bin/bash` 
- straing system settings: system partition is writable mounted
> a root detection is other security layer to secure your app; by not allowing your app to work in rooted device, cause root can access entire app data 